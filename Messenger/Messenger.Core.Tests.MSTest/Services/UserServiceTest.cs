...
public class UserServiceTest
{
    ...
    public void GetOrCreateApplicationUserExisting_Test()
    {
        ...
        {
            var data = new User() {
                Id=testName+"UserId", DisplayName=testName+"UserName"
            };
    ...
    public void GetOrCreateApplicationUserSecondNameId_Test()
    {
        ...
        {
            var user1 = new User() {
                Id=testName+"UserId1", DisplayName=testName+"UserName"
            };
            var user2 = new User() {
                Id=testName+"UserId2", DisplayName=testName+"UserName"
            };
    ...
    public void SearchUser_Test()
    {
        ...
        Task.Run(async () =>
        {
            List<User> users = new List<User> {
                new User() {
                    Id="Id1",  NameId=1, DisplayName=$"{testName}1"
                }
                , new User() {
                    Id="Id2",  NameId=2, DisplayName=$"{testName}1"
                }
                , new User() {
                    Id="Id3",  NameId=1, DisplayName=$"The{testName}2"
                }
                , new User() {
                    Id="Id4",  NameId=1, DisplayName=$"Another{testName}"
                }
                , new User() {
                    Id="Id5",  NameId=1, DisplayName=$"YetAnother{testName}"
                }
                , new User() {
                    Id="Id6",  NameId=1, DisplayName=$"ThisIsA{testName}"
                }
                , new User() {
                    Id="Id7",  NameId=1, DisplayName=$"A{testName}ThisBe"
                }
                , new User() {
                    Id="Id8",  NameId=1, DisplayName=$"SomeText"
                }
                , new User() {
                    Id="Id9",  NameId=1, DisplayName=$"Yeet"
                }
                , new User() {
                    Id="Id10", NameId=1, DisplayName=$"Oi mate"
                }
                , new User() {
                    Id="Id11", NameId=1, DisplayName=$"Deez Nuts {testName}"
                }
                , new User() {
                    Id="Id12", NameId=1, DisplayName=$"  "
                }
                , new User() {
                    Id="Id13", NameId=1, DisplayName=$"jdhsjdhjdhj{testName}dksdskdjkdjsk"
                }
                , new User() {
                    Id="Id14", NameId=1, DisplayName=$"ksjdksjdahdj"
                }
                , new User() {
                    Id="Id15", NameId=1, DisplayName=$"jdhsjdhjdhj {testName} dksdskdjkdjsk"
                }
            };
    ...
    public void ChangeBio_Test()
    {
        ...
        Task.Run(async () =>
        {
            ...
            var user = await UserService.GetOrCreateApplicationUser(new User() {
                Id = userId,DisplayName = testName + "UserName", Bio=testName + "Bio"
            });
            ...
            user = await UserService.GetOrCreateApplicationUser(new User() {
                Id = userId
            });
            Assert.IsNotNull(user);
    ...
    public void ChangeMail_Test()
    {
        ...
        Task.Run(async () =>
        {
            ...
            var user = await UserService.GetOrCreateApplicationUser(new User() {
                Id = userId,DisplayName = testName + "UserName", Mail=testName + "Mail"
            });
            Assert.IsNotNull(user);
    ...
    public void ChangePhoto_Test()
    {
        ...
        Task.Run(async () =>
        {
            ...
            var user = await UserService.GetOrCreateApplicationUser(new User() {
                Id = userId,DisplayName = testName + "UserName", Photo=testName + "Photo"
            });
            Assert.IsNotNull(user);
